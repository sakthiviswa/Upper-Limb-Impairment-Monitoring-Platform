            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
                <div style={{
                  ...
                  <IconCamera size={17} color="#2563EB" />
                </div>
                <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, width: '100%' }}>
                    {STEPS.map((s, i) => (
                      <div key={i} style={{
                        ...
                        <span style={{ fontFamily: "'JetBrains Mono', monospace", color: '#2563EB', fontWeight: 700, fontSize: 13, lineHeight: 1, flexShrink: 0, opacity: 0.8 }}>
                          {s.n}
                        </span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{
                  ...
                  {['Ensure good lighting on your arm', 'Wear a fitted sleeve or roll it up', 'Keep your body centered in frame', 'Avoid fast or jerky movements'].map((t, i) => (
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: '#93C5FD', padding: '3px 0', opacity: 0.85 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    {phase === 'monitoring' && !poseReady && !poseError && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>
                        <Spinner size={12} color="#93C5FD" /> Initializing pose…
                      </div>
                    )}
                  </div>
                ...
                <div style={{ position: 'relative', background: '#000', lineHeight: 0, flex: isMaximized ? 1 : 'none' }}>
                  ...
                  {showGuide && (
                    <div style={{
                      ...
                      <p style={{ margin: '0 0 10px', fontSize: 10, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#2563EB' }}>
                        Exercise Steps
                      </p>
                      {STEPS.map((s, i) => (
                        <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 8 }}>
                          <span style={{ fontFamily: "'JetBrains Mono', monospace", color: '#2563EB', fontWeight: 700, fontSize: 11, flexShrink: 0 }}>
                            {s.n}
                          </span>
                      ...
                      <div style={{
                        ...
                        {[['Avg', `${s.avg}°`], ['Max', `${s.max}°`], ['Min', `${s.min}°`], ['Acc', `${s.accuracy}%`]].map(([l, v]) => (
                          <div key={l} style={{
                            ...
                            <div style={{ fontSize: 16, fontWeight: 700, fontFamily: "'JetBrains Mono', monospace", color: '#93C5FD' }}>{v}</div>
                    ...
                    <div style={{
                      ...
                      <div style={{ position: 'relative', width: 52, height: 52 }}>
                        <svg width="52" height="52" style={{ transform: 'rotate(-90deg)' }}>
                          ...
                          <circle
                            cx="26" cy="26" r="20" fill="none" stroke="#2563EB" strokeWidth="4"
