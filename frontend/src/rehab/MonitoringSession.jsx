...
const STATUS_CFG = {
  improving: { color: '#22C55E', bg: 'rgba(34,197,94,0.1)', border: 'rgba(34,197,94,0.3)', label: 'Improving' },
  stable: { color: '#2563EB', bg: 'rgba(37,99,235,0.1)', border: 'rgba(37,99,235,0.3)', label: 'Stable' },
  needs_attention: { color: '#EF4444', bg: 'rgba(239,68,68,0.1)', border: 'rgba(239,68,68,0.3)', label: 'Needs Attention' },
  first_session: { color: '#64748B', bg: 'rgba(100,116,139,0.1)', border: 'rgba(100,116,139,0.3)', label: 'First Session' },
}
...
function MetricCard({ label, value, accent }) {
  return (
    <div style={{
      background: accent ? 'rgba(37,99,235,0.08)' : 'var(--bg-card2)',
      border: `1px solid ${accent ? 'rgba(37,99,235,0.25)' : 'var(--border-light)'}`,
      borderRadius: 14, padding: '18px 12px',
      display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5,
      boxShadow: accent ? '0 0 20px rgba(37,99,235,0.12)' : 'none',
      transition: 'all 0.2s',
    }}>
      <span style={{
        fontSize: 26, fontWeight: 700,
        fontFamily: "'JetBrains Mono', 'Fira Code', monospace",
        color: accent ? '#93C5FD' : 'var(--text-primary)', lineHeight: 1,
      }}>{value}</span>
...
function ExerciseDiagram() {
  return (
    <svg viewBox="0 0 480 170" fill="none" xmlns="http://www.w3.org/2000/svg"
      ...
      <circle cx="70" cy="38" r="11" fill="rgba(37,99,235,0.15)" stroke="#2563EB" strokeWidth="1.5" />
      <line x1="70" y1="49" x2="70" y2="88" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="70" y1="60" x2="112" y2="76" stroke="#1d4ed8" strokeWidth="3.5" strokeLinecap="round" />
      <line x1="112" y1="76" x2="155" y2="76" stroke="#2563EB" strokeWidth="3.5" strokeLinecap="round" />
      <circle cx="112" cy="76" r="5" fill="#2563EB" />
      <circle cx="155" cy="76" r="3.5" fill="#93C5FD" />
      <text x="130" y="70" fontSize="9" fill="var(--text-secondary)" fontFamily="monospace">~170°</text>
      <line x1="70" y1="88" x2="58" y2="118" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="70" y1="88" x2="82" y2="118" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      ...
      <circle cx="255" cy="38" r="11" fill="rgba(37,99,235,0.15)" stroke="#2563EB" strokeWidth="1.5" />
      <line x1="255" y1="49" x2="255" y2="88" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="255" y1="60" x2="297" y2="76" stroke="#1d4ed8" strokeWidth="3.5" strokeLinecap="round" />
      <line x1="297" y1="76" x2="297" y2="42" stroke="#2563EB" strokeWidth="3.5" strokeLinecap="round" />
      <circle cx="297" cy="76" r="5" fill="#2563EB" />
      <circle cx="297" cy="42" r="3.5" fill="#93C5FD" />
      <path d="M297 62 A16 16 0 0 1 281 76" stroke="#2563EB" strokeWidth="1.5" fill="none" />
      <text x="302" y="62" fontSize="9" fill="#93C5FD" fontFamily="monospace" fontWeight="700">90°</text>
      <line x1="255" y1="88" x2="243" y2="118" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="255" y1="88" x2="267" y2="118" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      ...
      <circle cx="408" cy="38" r="11" fill="rgba(37,99,235,0.15)" stroke="#2563EB" strokeWidth="1.5" />
      <line x1="408" y1="49" x2="408" y2="88" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="408" y1="60" x2="438" y2="78" stroke="#1d4ed8" strokeWidth="3.5" strokeLinecap="round" />
      <line x1="438" y1="78" x2="424" y2="46" stroke="#2563EB" strokeWidth="3.5" strokeLinecap="round" />
      <circle cx="438" cy="78" r="5" fill="#2563EB" />
      <circle cx="424" cy="46" r="3.5" fill="#93C5FD" />
      ...
      <line x1="408" y1="88" x2="396" y2="118" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="408" y1="88" x2="420" y2="118" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" />

      <circle cx="24" cy="148" r="4" fill="#1d4ed8" />
      <text x="32" y="152" fontSize="9" fill="var(--text-muted)" fontFamily="system-ui">Shoulder</text>
      <circle cx="100" cy="148" r="4" fill="#2563EB" />
      <text x="108" y="152" fontSize="9" fill="var(--text-muted)" fontFamily="system-ui">Elbow (tracked)</text>
      <circle cx="212" cy="148" r="4" fill="#93C5FD" />
...
export default function MonitoringSession({ patient, onSessionComplete }) {
  ...
  const chartOpts = {
    ...
    scales: {
      x: { 
        ticks: { color: T.chartTick, font: { size: isMobile ? 8 : 10 }, maxTicksLimit: isMobile ? 6 : 10 }, 
        grid: { color: T.chartGrid } 
      },
      y: { 
        min: 0, max: 180, 
        ticks: { color: T.chartTick, stepSize: 45, font: { size: isMobile ? 8 : 10 } }, 
        grid: { color: T.chartGrid } 
      },
    },
    plugins: {
  ...
  return (
    <div style={{
      ...
      paddingBottom: isMobile && phase === 'monitoring' ? 100 : 24,
    }}>
      <style>{`
        ...
        .ms-cam-btn:hover  { border-color: rgba(37,99,235,0.5); background: rgba(37,99,235,0.15); color: #93C5FD; }
        .ms-cam-btn.active { border-color: rgba(37,99,235,0.5); background: rgba(37,99,235,0.15); color: #93C5FD; }
        .ms-cam-icon-btn {
        ...
        .ms-cam-icon-btn:hover  { border-color: rgba(37,99,235,0.5); background: rgba(37,99,235,0.15); color: #93C5FD; }
        .ms-cam-icon-btn.active { border-color: rgba(37,99,235,0.5); background: rgba(37,99,235,0.15); color: #93C5FD; }
        .ms-camera-layout {
          display: grid;
          grid-template-columns: ${isMobile ? '1fr' : '1.5fr 1fr'};
        ...
        .ms-mobile-bottom-sheet {
          ...
          max-height: 70vh;
          overflow-y: auto;
          animation: ms-slideup 0.3s ease;
          box-shadow: 0 -4px 30px rgba(0,0,0,0.2);
        }
        .ms-mobile-bottom-sheet-close {
          position: sticky;
          top: 0;
          display: flex;
          ...
          <div style={{ marginBottom: isMobile ? 16 : 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
              <div style={{
                ...
                <IconCamera size={isMobile ? 15 : 17} color="#2563EB" />
              </div>
              <div>
                <h2 style={{ 
                  margin: 0, 
                ...
                <p style={{ margin: 0, fontSize: isMobile ? 11 : 12, color: 'var(--text-muted)' }}>
          ...
          <div style={{ 
            ...
            <div className="ms-section">
              <div className="ms-section-header">
                ...
                <span style={{
                  fontSize: isMobile ? 9 : 10, fontWeight: 600, padding: '3px 10px', borderRadius: 99,
                  ...
                  {STEPS.map((s, i) => (
                    <div key={i} style={{
                      ...
                      <span style={{ 
                        ...
                        lineHeight: 1, flexShrink: 0, opacity: 0.8 
                      }}>
                        {s.n}
                      </span>
                      <span style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 12 : 16 }}>
              ...
              <div className="ms-section">
                ...
                <div style={{ padding: isMobile ? 16 : 20, paddingTop: isMobile ? 12 : 16 }}>
                  {cameraError && (
                    <div style={{
                      background: 'var(--danger-bg)', border: '1px solid var(--danger-border)',
                      borderRadius: 10, padding: '10px 14px', fontSize: isMobile ? 11 : 12,
              ...
              <div style={{
                ...
                borderRadius: 14, padding: isMobile ? '14px 16px' : '16px 18px',
              }}>
                ...
                {['Ensure good lighting on your arm', 'Wear a fitted sleeve or roll it up', 'Keep your body centered in frame', 'Avoid fast or jerky movements'].map((t, i) => (
                  <div key={i} style={{ 
                    ...
                    fontSize: isMobile ? 11 : 12, 
                    color: '#93C5FD', padding: '3px 0', opacity: 0.85 
                  }}>
      ...
      {(phase === 'camera_preview' || phase === 'monitoring') && (
        <div style={{
          ...
          gap: isMaximized ? 0 : (isMobile ? 12 : 20),
            ...
            <div style={{ 
              ...
              {phase === 'monitoring' && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontSize: isMobile ? 10 : 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#f87171' }}>
                    Recording
                  </span>
                </div>
              )}
          ...
          <div className={`ms-camera-layout`} style={{
            gridTemplateColumns: isMaximized ? '1fr' : (isMobile ? '1fr' : '1.5fr 1fr'),
            gap: isMaximized ? 0 : (isMobile ? 12 : 20),
            alignItems: 'start',
          }}>
            ...
            <div
              ...
              style={{
                background: '#000',
                display: 'flex', flexDirection: 'column',
                borderRadius: isMaximized ? 0 : (isMobile ? 12 : 16),
                overflow: 'hidden',
              }}
            >
              {/* Toolbar */}
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 6 : 10 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    ...
                    <span style={{ 
                      ...
                      color: 'rgba(255,255,255,0.5)',
                      display: isMobile && phase === 'camera_preview' ? 'none' : 'inline',
                    }}>
                  ...
                  {phase === 'monitoring' && (
                    <>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                        <span style={{ width: isMobile ? 5 : 6, height: isMobile ? 5 : 6, borderRadius: '50%', background: '#f87171', animation: 'ms-blink 1s infinite' }} />
                        <span style={{ 
                          fontSize: isMobile ? 8 : 10, 
                          fontWeight: 700, 
                          letterSpacing: '0.12em', 
                  ...
                  {phase === 'monitoring' && !poseReady && !poseError && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: isMobile ? 9 : 11, color: 'rgba(255,255,255,0.4)' }}>
                      <Spinner size={isMobile ? 10 : 12} color="#93C5FD" /> 
                      <span style={{ display: isMobile ? 'none' : 'inline' }}>Initializing…</span>
                    </div>
                  )}
                </div>
                ...
                <div className="ms-cam-toolbar" style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 4 : 6 }}>
                  ...
                  >
                    <svg width={isMobile ? 11 : 13} height={isMobile ? 11 : 13} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                      <rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/>
                      <rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/>
                    </svg>
                  </button>

                  {/* Guide toggle - hide text on mobile */}
                  <button
                  ...
                  >
                    {isMobile ? (
                      isMaximized ? <IconMinimize size={12} color="currentColor" /> : <IconMaximize size={12} color="currentColor" />
                    ) : (
              ...
              <div style={{ 
                ...
                {phase === 'camera_preview' && !countdown && (
                  <div style={{
                    ...
                    paddingBottom: isMobile ? 20 : 28, zIndex: 10,
                  }}>
                    <div style={{ textAlign: 'center', animation: 'ms-slideup 0.25s ease', padding: isMobile ? 16 : 0 }}>
                      {!isMobile && (
                ...
                {countdown !== null && (
                  <div style={{
                    ...
                    <div style={{
                      fontSize: isMobile ? 72 : 100, fontWeight: 700,
                      fontFamily: "'JetBrains Mono', monospace",
                      color: '#fff',
                ...
                {phase === 'monitoring' && !poseReady && !poseError && (
                  <div style={{
                    ...
                    gap: 12, fontSize: isMobile ? 12 : 13, color: '#94a3b8', zIndex: 5,
                  }}>
                    <Spinner size={isMobile ? 24 : 28} color="#93C5FD" />
                    <span style={{ fontWeight: 500, textAlign: 'center', padding: '0 16px' }}>
                      {isMobile ? 'Loading pose…' : 'Initializing pose detection…'}
                    </span>
                  </div>
                )}
                ...
                {poseError && (
                  <div style={{
                    ...
                    <span style={{ color: '#f87171', fontSize: isMobile ? 12 : 13, fontWeight: 600, textAlign: 'center' }}>
                      Camera error: {poseError}
                    </span>
                  </div>
                )}

                {/* Guide overlay - mobile optimized */}
                {showGuide && (
                  <div style={{
                    position: 'absolute', 
                    top: isMobile ? 8 : 12, 
                    ...
                    <p style={{ margin: '0 0 10px', fontSize: isMobile ? 9 : 10, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#2563EB' }}>
                      {isMobile ? 'Steps' : 'Exercise Steps'}
                    </p>
                    {STEPS.map((s, i) => (
                      <div key={i} style={{ 
                        display: 'flex', 
                ...
                {/* Angle HUD chip - mobile optimized */}
                {phase === 'monitoring' && (
                  <div style={{
                    position: 'absolute', 
                    ...
                    <div style={{
                      fontSize: isMobile ? 28 : (isMaximized ? 48 : 38),
                      fontWeight: 700,
                      fontFamily: "'JetBrains Mono', monospace",
                ...
                {!isMaximized && phase === 'monitoring' && (
                  <div style={{
                    ...
                    borderRadius: 8, padding: isMobile ? '3px 10px' : '5px 12px',
                    fontSize: isMobile ? 10 : 11, 
                ...
                {isMaximized && phase === 'monitoring' && (
                  <div style={{
                    ...
                    <div style={{ position: 'relative', width: isMobile ? 40 : 52, height: isMobile ? 40 : 52 }}>
                      <svg width={isMobile ? 40 : 52} height={isMobile ? 40 : 52} style={{ transform: 'rotate(-90deg)' }}>
                        <circle 
                          cx={isMobile ? 20 : 26} 
                          cy={isMobile ? 20 : 26} 
                          r={isMobile ? 14 : 20} 
                        ...
                        <circle
                          ...
                          strokeWidth={isMobile ? 3 : 4}
                          strokeDasharray={2 * Math.PI * (isMobile ? 14 : 20)}
                          strokeDashoffset={(2 * Math.PI * (isMobile ? 14 : 20)) - (2 * Math.PI * (isMobile ? 14 : 20) * timerPct / 100)}
                          strokeLinecap="round"
              ...
              {!isMaximized && phase === 'monitoring' && currentAngle !== null && (
                <div style={{
                  ...
                  <div style={{ height: isMobile ? 4 : 5, background: 'rgba(255,255,255,0.08)', borderRadius: 99, overflow: 'hidden' }}>
                    <div style={{
                      height: '100%', borderRadius: 99,
                      width: `${Math.min(100, (currentAngle / 180) * 100)}%`,
                      background: `linear-gradient(90deg, #2563EB, ${angleColor})`,
                      ...
                      {['Stand side-on to the camera', 'Keep arm visible from shoulder to wrist', 'Ensure good lighting'].map((tip, i) => (
                        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: 'var(--text-muted)' }}>
                          <div style={{
                            ...
                            <span style={{ fontSize: 9, fontWeight: 700, color: '#2563EB', fontFamily: 'monospace' }}>{i + 1}</span>
                          </div>
                          {tip}
                        </div>
                      ))}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 6, width: '100%' }}>
                          {[['Avg', `${s.avg}°`], ['Max', `${s.max}°`], ['Min', `${s.min}°`], ['Acc', `${s.accuracy}%`]].map(([l, v]) => (
                            <div key={l} style={{
                              ...
                              <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "'JetBrains Mono', monospace", color: '#93C5FD' }}>
                                {v}
                              </div>
      ...
      {!isMaximized && isMobile && phase === 'monitoring' && (
        <div className="ms-mobile-fab">
          <button
          ...
          >
            ...
            <IconChevronDown 
              size={12} 
              color="var(--text-muted)" 
              style={{ transform: showMobileStats ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}
            />
          </button>
          <button
            onClick={() => { clearInterval(timerRef.current); _finishSession() }}
          ...
          >
            <IconStop size={12} color="var(--danger)" /> Stop
          </button>
        </div>
      )}

      {/* ── Mobile Bottom Sheet for Stats ── */}
      {!isMaximized && isMobile && phase === 'monitoring' && showMobileStats && (
        <div className="ms-mobile-bottom-sheet">
          <div className="ms-mobile-bottom-sheet-close">
            <button
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 8, marginBottom: 16 }}>
                {[['Avg', `${s.avg}°`], ['Max', `${s.max}°`], ['Min', `${s.min}°`], ['Acc', `${s.accuracy}%`]].map(([l, v]) => (
                  <div key={l} style={{
                    ...
                    <div style={{ fontSize: 16, fontWeight: 700, fontFamily: "'JetBrains Mono', monospace", color: '#93C5FD' }}>
                      {v}
                    </div>
                    <div style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted)', marginTop: 2 }}>
                      {l}
                    </div>
                  </div>
                ))}
      ...
      {phase === 'complete' && summary && (
        <div style={{ 
          ...
          {/* Header card */}
          <div className="ms-section" style={{ padding: isMobile ? '20px 16px' : '28px 32px', textAlign: 'center' }}>
            <div style={{
              ...
              <svg width={isMobile ? 20 : 24} height={isMobile ? 20 : 24} viewBox="0 0 24 24" fill="none" stroke="#34d399" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Full session chart */}
          <div className="ms-section" style={{ padding: isMobile ? '16px' : '20px 24px' }}>
          ...
          <div style={{ 
            ...
            <button
              ...
              style={{
                ...
                fontSize: isMobile ? 14 : 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit',
                width: isMobile ? '100%' : 'auto',
              }}
            >
              <IconRefresh size={isMobile ? 14 : 15} color="currentColor" /> New Session
            </button>
          </div>
