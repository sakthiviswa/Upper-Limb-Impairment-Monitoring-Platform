...
const STATUS_CFG = {
  ...
  stable:          { color: '#2563EB', label: 'Stable',          Icon: Minus        },
  needs_attention: { color: '#EF4444', label: 'Needs Attention', Icon: TrendingDown },
  first_session:   { color: '#64748B', label: 'First Session',   Icon: Activity     },
}

function StatusBadge({ status }) {
  const cfg = STATUS_CFG[status] || STATUS_CFG.stable
  return (
    <span className="fp-badge" style={{ color: cfg.color, background: `${cfg.color}15`, borderColor: `${cfg.color}35` }}>
