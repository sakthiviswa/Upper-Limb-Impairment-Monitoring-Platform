...
export default function BookAppointmentPanel({ assignedDoctorId, assignedDoctorName }) {
    ...
    return (
      <div className="fp-root">
        ...
        <Card>
          ...
          {loadingList ? (
            <div className="fp-empty" style={{ padding: '3rem' }}>
              <div className="fp-spinner" />
              <div className="fp-empty__text">Loading appointments…</div>
            ...
            <div className="fp-empty" style={{ padding: '3rem' }}>
              ...
              <div className="fp-empty__title">No appointments yet</div>
              <div className="fp-empty__text">Book your first appointment above.</div>
            </div>
          ) : (
  ...
  return (
    <div className="fp-root">
      ...
      {/* Back + title */}
      <div className="fp-header">
        <div className="fp-header__left" style={{ alignItems: 'center' }}>
          <button type="button" onClick={() => setView('list')} className="fp-btn fp-btn--ghost">
            ← Back
          </button>
          <div>
        ...
        <div style={{ padding: '20px 24px' }}>
          ...
          <FieldWrap>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              {[
                { val: 'online',  icon: Video,  label: 'Online',   sub: 'Google Meet',  color: '#2563EB' },
                { val: 'offline', icon: MapPin, label: 'In-Clinic', sub: 'Visit doctor', color: '#0EA5E9' },
              ].map(opt => {
                const Icon  = opt.icon
