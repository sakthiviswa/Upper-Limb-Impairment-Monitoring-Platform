...
import {
  Card, StatCard, SectionHeader, PageSection, LoadingScreen,
} from '../components/ui'
import { useToast }    from '../components/ToastProvider'
import {
  CalendarDays, Pill, Activity, Play, FileText,
  Clock, AlertCircle, TrendingUp, ChevronRight, Zap, Bell,
  CheckCircle, Video, MapPin, Plus, BarChart2, LayoutDashboard,
} from 'lucide-react'
        ...
        <div className="page-container">
          ...
          <div className="page-header">
            ...
            >
              ...
              Notifications
              {unreadCount > 0 && (
                <span className="app-sidebar__badge">{unreadCount}</span>
              )}
            </button>
          </div>
